...
const DESCRIPTION = 'Как работает челлендж проп-фирмы: оплата, этапы оценки, просадка, funded-правила, выплаты и проверка страны на текущих примерах.'
...
const faqs: RussianFaqItem[] = [
  ...
  },
  {
    ...
    a: 'Только если конкретный продукт не устанавливает минимальные торговые дни и другие ограничения. Быстрое достижение цели не отменяет проверку стратегии, KYC и funded-правил.',
  },
  {
  ...
  },
  {
    ...
    a: 'Нет. После оценки действуют договор, KYC, funded-правила, минимальная прибыль, consistency rule, даты и способы выплаты. Нарушение на funded-этапе может лишить права на вознаграждение.',
  },
]
...
export default function RussianChallengeLifecyclePage() {
  ...
  return (
    <>
      ...
      <section className="ru-section">
        <div className="ru-shell ru-content">
          ...
          <p>
            ...
            продукт переходит к внутренней проверке результатов, а phase-0 продукт
            начинает сразу с funded-правил. «Instant» описывает отсутствие оценки,
          ...
          <div className="ru-table-wrap">
            <table className="ru-table">
              ...
              <tbody>
                <tr><td>Phase 0 / instant</td><td>{phaseCounts.find(item => item.phases === 0)?.count ?? 0}</td><td>оценку и verification</td><td>KYC, funded-правила, payout gate</td></tr>
      ...
      <section className="ru-section">
        <div className="ru-shell ru-content">
          <h2>Этап 4. Funded-правила</h2>
          <p>
            После оценки правила могут измениться. Часто добавляются payout buffer,
            consistency rule, лимит контрактов, запрет новостей, ограничение копирования
          ...
          <ol>
            ...
            <li>Отметьте новости, ночь, выходные, EA и copy trading.</li>
            <li>Рассчитайте consistency до первой крупной прибыльной сделки.</li>
          </ol>
        </div>
      </section>
      ...
      <section className="ru-section">
        <div className="ru-shell ru-content">
          ...
          <p>
            ...
            прибыльные дни, buffer, consistency, закрытые позиции, комиссию провайдера
            и совпадение имени получателя с KYC.
          </p>
          <div className="ru-card">
            <WalletCards size={24} color="var(--accent-light)" aria-hidden="true" />
            <h3>Формула проверки</h3>
            <p className="ru-muted">Право по календарю + выполненный profit gate + соблюдённая consistency + разрешённый payout rail + подтверждённый KYC = возможность подать запрос. Это ещё не обещание одобрения.</p>
          </div>
