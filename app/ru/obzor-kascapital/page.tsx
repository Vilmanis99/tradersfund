      ...
      <section className="ru-section">
        <div className="ru-shell ru-content">
          ...
          <div className="ru-grid">
            ...
            <article className="ru-card"><FileCheck2 size={22} color="var(--accent-light)" aria-hidden="true" /><h3>Пayout по понедельникам</h3><p className="ru-muted">Дата выплаты зависит от времени подачи заявки: на странице указаны пятничный срез и следующий понедельник. Сохраните действующий регламент и подтверждение заявки.</p><SourceLink href={KAS_HOME}>FAQ о выплатах</SourceLink></article>
