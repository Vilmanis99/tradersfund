    ...
    <>
      ...
      <section className="ru-hero">
        <div className="ru-shell" data-russian-crypto-hero="search-and-product-evidence">
          ...
          <h1>{TITLE}</h1>
          <p className="ru-lead">
            Для запроса «проп трейдинг криптовалют» мы сравниваем не крипто-оплату, а точные продукты,
            где первичный источник прямо подтверждает торговлю цифровыми активами. Сейчас фильтр проходят
