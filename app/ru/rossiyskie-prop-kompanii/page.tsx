...
const faqs: RussianFaqItem[] = [
  ...
  },
  {
    ...
    a: 'У Era Trade опубликована стандартная программа с 5% за прямые покупки и уровнями до 60%. PropLive предлагает договорную модель наставникам и школам с долей до 50% от прибыли учеников. На сайте KasCapital публичных affiliate- или referral-условий при проверке не найдено.',
  },
  {
          ...
          <div className="ru-table-wrap">
            <table className="ru-table">
              ...
              <tbody>
                ...
                <tr>
                  <td>PropLive</td>
                  <td>До {propLiveAffiliate?.maximumPublishedCommissionPct}% PayOut от прибыли учеников; только наставники и школы, условия после заявки.</td>
                  <td>Не подходит как обычная издательская affiliate-ссылка.</td>
                </tr>
                <tr>
                  <td>KasCapital</td>
                  <td>Публичные affiliate/referral-условия на официальном сайте не найдены.</td>
