...
const faqs: RussianFaqItem[] = [
  ...
  {
    q: 'Как искать проп-фирмы для русскоязычных в Европе или Грузии?',
    a: 'Ищите по языку только как по входному запросу, а не как по фильтру доступа. Для Европы, Грузии, Армении, Израиля, США и других стран отдельно проверьте резидентство, гражданство, KYC, платёж и выплату в правилах выбранного продукта.',
  },
]
    ...
    <>
      ...
      <section className="ru-section" id="global-regions">
        <div className="ru-shell ru-content" data-russian-diaspora-regions="global-routes">
          ...
          <p>
            Запросы «проп-фирмы для русскоязычных в Европе», «проп-фирмы для трейдеров в Грузии» и
            «проп-фирмы для русскоязычных в Израиле» описывают язык аудитории, но не создают отдельный
            статус у фирмы. Один и тот же глобальный продукт нужно проверять по вашей фактической стране,
            документу и маршруту выплаты.
          </p>
          <div className="ru-grid">
            <article className="ru-card">
              <Globe2 size={22} color="var(--accent-light)" aria-hidden="true" />
