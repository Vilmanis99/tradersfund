    ...
    <>
      ...
      <section className="ru-section">
        <div className="ru-shell" data-russian-partner-shortlist="global">
          ...
          <p className="ru-muted">Русский язык страницы не означает доступность для резидента России. Сначала откройте разбор и сверяйте страну на официальной странице оплаты. Если дата продукта вышла за редакционное окно, карточка остаётся навигацией, а не заменой свежего checkout.</p>
