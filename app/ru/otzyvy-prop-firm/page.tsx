            ...
            <div className="ru-table-wrap">
              <table className="ru-table">
                ...
                <tbody>
                  ...
                  <tr><td><strong>TeamTraders</strong></td><td>{localClaim('TeamTraders', 'stageProfitPct')}% цель, минимум {localClaim('TeamTraders', 'minimumTradingSessions')} сессий, {localClaim('TeamTraders', 'dailyLossLimitPct')}% дневной лимит и до {localClaim('TeamTraders', 'profitSharePct')}% доли</td><td>Четыре локальных числа нельзя подставлять в правила Stellar или Bright — там другие продукты и источники.</td><td><a href="https://teamtraders.ru/docs/" target="_blank" rel="nofollow noopener">Документация</a></td></tr>
