      ...
      <section className="ru-section">
        <div className="ru-shell" data-russian-affiliate-disclosure="kyc-guide">
          <div className="ru-notice ru-disclosure">
            ...
            Ниже показаны только глобальные фирмы с активной партнёрской ссылкой. Карточка ведёт к проверке фирмы, но не обещает, что её KYC-правила уже подтверждены для вашей страны.
