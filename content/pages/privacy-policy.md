...
<p>Our custom journey events contain page paths and limited labels such as a firm slug or link placement. They do not contain a submitted name, email address, message, form field value, account identifier, or full query string. Clarity form-content capture is not used as a source of editorial evidence or user profiling.</p>
