...
<p>The <a href="/blog/my-funded-futures">My Funded Futures review</a> is a useful same-firm stage comparison. Rapid and Pro apply a captured 50% rule during evaluation, Rapid EOD uses 30% during evaluation, Flex is now legacy, and Builder records no evaluation percentage but a 50% rule after funding. The percentage and stage must be read together.</p>
