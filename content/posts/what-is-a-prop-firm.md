...
<table style="width: 100%; border-collapse: collapse; margin: 1rem 0; font-size: 0.88rem;">
  ...
  <tbody>
    ...
    <tr data-prop-firm-example="topstep:trading-combine-standard-path"><td style="padding: 8px 12px;"><a href="/blog/topstep-review">Topstep Standard Path, $100K</a></td><td style="padding: 8px 12px;">$99 monthly until pass or cancellation, plus $149 activation after passing</td><td style="padding: 8px 12px;">1 phase; 6% target; $3,000 end-of-day trailing maximum-loss amount</td><td style="padding: 8px 12px;">90% share; request eligibility: 3 trading days with 40% consistency or 5 winning days of at least $150; not transfer time</td><td style="padding: 8px 12px;">2026-09-08</td></tr>
  </tbody>
</table>
...
<p>The <a href="/best-prop-firms-2026">2026 best-prop-firms ranking</a> applied that separation to 16 firms and 66 fresh product records in the 2026-09-14 snapshot: editorial score creates the shortlist, while each card exposes current product coverage and a dated first-party source before the trader chooses a fee or rule set. The count changes when a product capture leaves the 30-day window.</p>
...
<p>An instant product has 0 evaluation phases, but it still has funded-stage loss and reward rules. FundedNext Stellar Instant currently records a 6% trailing maximum loss, a 70% starting share, and a non-refundable $299.99 price at the $10K tier. The <a href="/best-instant-funding-prop-firms">instant-funding comparison</a> separates those terms across firms.</p>
