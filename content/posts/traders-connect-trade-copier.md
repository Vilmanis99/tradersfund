...
<p>The product has 3 layers: account connections, copier rules, and optional controls. A trader connects a master account and at least 1 follower account, selects a risk calculation, then decides how entries, exits, pending orders, stop losses, take profits, comments, and symbol differences should be handled.</p>
