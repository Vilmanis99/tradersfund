...
<table style="width: 100%; border-collapse: collapse; margin: 1rem 0; font-size: 0.92rem;">
  <caption class="hidden-caption">FundingPips at a glance</caption>
  <tbody>
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);"><strong>Captured products</strong></td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">5 products across 29 account-size rows</td></tr>
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);"><strong>Published sizes</strong></td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$5K to $200K verified; 2 disputed $2.5K rows retained as unknown</td></tr>
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);"><strong>Verified fees</strong></td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">27 of 29 rows</td></tr>
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);"><strong>Drawdown</strong></td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">4 static products; 1 trailing product</td></tr>
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);"><strong>Captured platforms</strong></td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">MT5, cTrader, Match-Trader</td></tr>
    <tr><td style="padding: 8px 12px;"><strong>India evidence</strong></td><td style="padding: 8px 12px;">Captured, but end-to-end checkout and payout access remain unproven</td></tr>
  </tbody>
</table>
...
<table style="width: 100%; border-collapse: collapse; margin: 1rem 0; font-size: 0.86rem;">
  ...
  <tbody>
    ...
    <tr><td>2 Step Standard</td><td>2</td><td>$25K</td><td>$177</td><td>8% / 5%</td><td>5% / 10% static</td><td>60%–100%</td></tr>
    <tr><td>2 Step Standard</td><td>2</td><td>$50K</td><td>$299</td><td>8% / 5%</td><td>5% / 10% static</td><td>60%–100%</td></tr>
    <tr><td>2 Step Standard</td><td>2</td><td>$100K</td><td>$544</td><td>8% / 5%</td><td>5% / 10% static</td><td>60%–100%</td></tr>
    <tr><td>FundingPips Zero</td><td>0</td><td>$5K</td><td>$60</td><td>—</td><td>3% / 5% trailing</td><td>95%</td></tr>
    <tr><td>FundingPips Zero</td><td>0</td><td>$10K</td><td>$88</td><td>—</td><td>3% / 5% trailing</td><td>95%</td></tr>
    <tr><td>FundingPips Zero</td><td>0</td><td>$25K</td><td>$188</td><td>—</td><td>3% / 5% trailing</td><td>95%</td></tr>
    <tr><td>FundingPips Zero</td><td>0</td><td>$50K</td><td>$244</td><td>—</td><td>3% / 5% trailing</td><td>95%</td></tr>
    <tr><td>FundingPips Zero</td><td>0</td><td>$100K</td><td>$444</td><td>—</td><td>3% / 5% trailing</td><td>95%</td></tr>
    <tr><td>FundingPips Zero</td><td>0</td><td>$200K</td><td>$888</td><td>—</td><td>3% / 5% trailing</td><td>95%</td></tr>
  </tbody>
</table>
...
<table style="width: 100%; border-collapse: collapse; margin: 1rem 0; font-size: 0.9rem;">
  <caption class="hidden-caption">1 Step Flex true-cost projection</caption>
  <thead><tr style="background: var(--bg3);"><th style="padding: 8px 12px; text-align: left;">Tier</th><th style="padding: 8px 12px; text-align: left;">Fee</th><th style="padding: 8px 12px; text-align: left;">Break-even profit (85% split)</th><th style="padding: 8px 12px; text-align: left;">R-multiple vs 12% max DD</th><th style="padding: 8px 12px; text-align: left;">Days @ 1%/day (3% daily cap)</th></tr></thead>
  <tbody>
    ...
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$50K</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$322</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$379</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">0.06</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">1</td></tr>
    <tr><td style="padding: 8px 12px;">$100K</td><td style="padding: 8px 12px;">$566</td><td style="padding: 8px 12px;">$666</td><td style="padding: 8px 12px;">0.06</td><td style="padding: 8px 12px;">1</td></tr>
  </tbody>
</table>

<!-- 2 Step Pro — generated by scripts/gen-truecost.mjs -->
<table style="width: 100%; border-collapse: collapse; margin: 1rem 0; font-size: 0.9rem;">
  <caption class="hidden-caption">2 Step Pro true-cost projection</caption>
  ...
  <tbody>
    ...
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$25K</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$134</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$168</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">0.11</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">1</td></tr>
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$50K</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$224</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$280</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">0.09</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">1</td></tr>
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$100K</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$422</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$528</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">0.09</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">1</td></tr>
    <tr><td style="padding: 8px 12px;">$200K</td><td style="padding: 8px 12px;">$844</td><td style="padding: 8px 12px;">$1,055</td><td style="padding: 8px 12px;">0.09</td><td style="padding: 8px 12px;">1</td></tr>
  </tbody>
</table>

<!-- FundingPips Zero — generated by scripts/gen-truecost.mjs -->
<table style="width: 100%; border-collapse: collapse; margin: 1rem 0; font-size: 0.9rem;">
  <caption class="hidden-caption">FundingPips Zero true-cost projection</caption>
  <thead><tr style="background: var(--bg3);"><th style="padding: 8px 12px; text-align: left;">Tier</th><th style="padding: 8px 12px; text-align: left;">Fee</th><th style="padding: 8px 12px; text-align: left;">Break-even profit (95% split)</th><th style="padding: 8px 12px; text-align: left;">R-multiple vs 5% trailing max DD</th><th style="padding: 8px 12px; text-align: left;">Days @ 1%/day (3% daily cap)</th></tr></thead>
  <tbody>
    ...
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$50K</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$244</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$257</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">0.10</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">1</td></tr>
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$100K</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$444</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$467</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">0.09</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">1</td></tr>
    <tr><td style="padding: 8px 12px;">$200K</td><td style="padding: 8px 12px;">$888</td><td style="padding: 8px 12px;">$935</td><td style="padding: 8px 12px;">0.09</td><td style="padding: 8px 12px;">1</td></tr>
  </tbody>
</table>
...
<p>Trustpilot showed 4.5/5 from 63,734 reviews on 2026-07-27, but the site’s verified-payout badge remains false. A large review aggregate is community evidence; it is not proof that one strategy, KYC profile, or payout request will clear the firm’s rules.</p>
...
<p>A trader who needs a verified $2.5K entry tier should avoid FundingPips because both retained $2.5K rows remain unresolved. An Indian trader who needs a proven local checkout-to-payout route should use our <a href="/best-prop-firms-in-india">India shortlist</a>, which includes only firms that clear those evidence gates.</p>
...
<h3 class="wp-block-heading"><strong>Can traders in India use FundingPips?</strong></h3>
<p>Not with enough confidence for our shortlist. First-party country, checkout, KYC, and payout evidence has been captured, but it does not prove an end-to-end Indian purchase and withdrawal, so FundingPips remains outside the 3-firm India shortlist.</p>

<h3 class="wp-block-heading"><strong>Can FundingPips true cost be calculated?</strong></h3>
<p>Yes for 1 Step Flex, 2 Step Pro, and Zero: the 17 priced rows above use <code>computeTrueCost()</code> with fixed splits of 85%, 80%, and 95%. Flex and Standard true cost remains split-dependent because each buyer selects one of 2 or 4 payout structures.</p>
