...
<table style="width: 100%; border-collapse: collapse; margin: 1rem 0; font-size: 0.9rem;">
  <caption class="hidden-caption">CTI break-even projection (estimates, 70% split)</caption>
  <thead><tr style="background: var(--bg3);"><th style="padding: 8px 12px; text-align: left;">Tier</th><th style="padding: 8px 12px; text-align: left;">Fee (estimate)</th><th style="padding: 8px 12px; text-align: left;">Break-even (70%)</th><th style="padding: 8px 12px; text-align: left;">R-multiple vs 10% DD</th></tr></thead>
  <tbody>
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$25K</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">~$180</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$257</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">0.10</td></tr>
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$50K</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">~$280</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$400</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">0.08</td></tr>
    <tr><td style="padding: 8px 12px;">$100K</td><td style="padding: 8px 12px;">~$480</td><td style="padding: 8px 12px;">$686</td><td style="padding: 8px 12px;">0.07</td></tr>
  </tbody>
</table>

<p><strong>The 70% split is the structural cost.</strong> Break-even profits at CTI are 12–25% higher than at an 80% split competitor for the same fee. The trade-off is the no-time-limit evaluation — swing traders who would otherwise pay multiple FTMO retries because the 30-day evaluation window is too tight may find CTI's all-in cost lower.</p>
