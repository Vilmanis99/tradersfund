...
<table style="width: 100%; border-collapse: collapse; margin: 1rem 0; font-size: 0.92rem;">
  <caption class="hidden-caption">City Traders Imperium at a glance</caption>
  <tbody>
...
<p>Break-even profit is the fee divided by your profit split — the trading gain you must produce before your share of it repays what you spent. The R-multiple sets that figure against the dollar value of your maximum drawdown. R below 1 means the firm lets you lose more getting there than you need to make; R at or above 1 means you must out-earn your entire loss allowance just to get back to zero. Every figure below is <code>computeTrueCost()</code> output from CTI's published prices — see <a href="/true-cost-of-prop-firm-challenges">the true cost of prop firm challenges</a> for the method.</p>

<p>The two evaluation products both pay an 80% split, and both land comfortably under R = 1 at every tier:</p>

<!-- 1-Step Challenge — generated by scripts/gen-truecost.mjs -->
<table style="width: 100%; border-collapse: collapse; margin: 1rem 0; font-size: 0.9rem;">
  <caption class="hidden-caption">1-Step Challenge true-cost projection</caption>
  <thead><tr style="background: var(--bg3);"><th style="padding: 8px 12px; text-align: left;">Tier</th><th style="padding: 8px 12px; text-align: left;">Fee</th><th style="padding: 8px 12px; text-align: left;">Break-even profit (80% split)</th><th style="padding: 8px 12px; text-align: left;">R-multiple vs 5% trailing max DD</th><th style="padding: 8px 12px; text-align: left;">Days @ 1%/day</th></tr></thead>
  <tbody>
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$2,500</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$29</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$36</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">0.29</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">2</td></tr>
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$5K</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$49</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$61</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">0.24</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">2</td></tr>
    ...
    <tr><td style="padding: 8px 12px;">$100K</td><td style="padding: 8px 12px;">$449</td><td style="padding: 8px 12px;">$561</td><td style="padding: 8px 12px;">0.11</td><td style="padding: 8px 12px;">1</td></tr>
  </tbody>
</table>

<!-- 2-Step Challenge — generated by scripts/gen-truecost.mjs -->
<table style="width: 100%; border-collapse: collapse; margin: 1rem 0; font-size: 0.9rem;">
  <caption class="hidden-caption">2-Step Challenge true-cost projection</caption>
  ...
  <tbody>
    ...
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$50K</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$329</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$411</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">0.08</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">1</td></tr>
...
<p>The 1-Step is the cheaper attempt at every size — $449 against $549 at $100K — but it buys a 5% <em>trailing</em> drawdown measured from your high-water mark, against the 2-Step's 10% static floor. On a $100K account that is $5,000 of room that moves up behind you versus $10,000 that does not. The 2-Step's R of 0.07 at $100K is the best number CTI publishes; its cost is clearing an 10% and then a 5% target instead of a single 8%.</p>

<p>The funded-from-day-one products invert that math, and this is the finding that matters most on this page:</p>

<!-- Instant Funding — generated by scripts/gen-truecost.mjs -->
<table style="width: 100%; border-collapse: collapse; margin: 1rem 0; font-size: 0.9rem;">
  <caption class="hidden-caption">Instant Funding true-cost projection</caption>
  <thead><tr style="background: var(--bg3);"><th style="padding: 8px 12px; text-align: left;">Tier</th><th style="padding: 8px 12px; text-align: left;">Fee</th><th style="padding: 8px 12px; text-align: left;">Break-even profit (50% split)</th><th style="padding: 8px 12px; text-align: left;">R-multiple vs 6% max DD</th><th style="padding: 8px 12px; text-align: left;">Days @ 1%/day</th></tr></thead>
  <tbody>
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$2,500</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$79</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$158</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">1.05</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">7</td></tr>
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$5K</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$139</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$278</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">0.93</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">6</td></tr>
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$10K</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$259</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$518</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">0.86</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">6</td></tr>
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$20K</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$449</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$898</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">0.75</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">5</td></tr>
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$40K</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$849</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$1,698</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">0.71</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">5</td></tr>
    <tr><td style="padding: 8px 12px;">$80K</td><td style="padding: 8px 12px;">$1,599</td><td style="padding: 8px 12px;">$3,198</td><td style="padding: 8px 12px;">0.67</td><td style="padding: 8px 12px;">4</td></tr>
  </tbody>
</table>

<!-- Direct Funding — generated by scripts/gen-truecost.mjs -->
<table style="width: 100%; border-collapse: collapse; margin: 1rem 0; font-size: 0.9rem;">
  <caption class="hidden-caption">Direct Funding true-cost projection</caption>
  <thead><tr style="background: var(--bg3);"><th style="padding: 8px 12px; text-align: left;">Tier</th><th style="padding: 8px 12px; text-align: left;">Fee</th><th style="padding: 8px 12px; text-align: left;">Break-even profit (70% split)</th><th style="padding: 8px 12px; text-align: left;">R-multiple vs 6% max DD</th><th style="padding: 8px 12px; text-align: left;">Days @ 1%/day</th></tr></thead>
  <tbody>
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$5K</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$229</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$327</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">1.09</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">7</td></tr>
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$10K</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$399</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$570</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">0.95</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">6</td></tr>
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$20K</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$999</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$1,427</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">1.19</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">7</td></tr>
    <tr><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$40K</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$1,999</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">$2,856</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">1.19</td><td style="padding: 8px 12px; border-bottom: 1px solid var(--border);">7</td></tr>
    <tr><td style="padding: 8px 12px;">$80K</td><td style="padding: 8px 12px;">$3,999</td><td style="padding: 8px 12px;">$5,713</td><td style="padding: 8px 12px;">1.19</td><td style="padding: 8px 12px;">7</td></tr>
  </tbody>
</table>

<p><strong>Instant Funding pays a 50% split, and Direct Funding costs up to $3,999.</strong> Both push the R-multiple to the edge of viability. At the $2,500 Instant tier you need $158 of profit against $150 of total permitted loss — R = 1.05, meaning a trader who blows the account has lost more than the profit target they were chasing. Direct Funding sits at R = 1.19 across its $20K, $40K and $80K tiers. These are not marginal differences from the evaluation route: the 2-Step at $100K is R = 0.07, roughly seventeen times more forgiving than Direct Funding at the same drawdown percentage.</p>
