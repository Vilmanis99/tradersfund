...
const russianExpectations = new Map([
  ['/ru', {
    ...
    markers: [
      ...
      'Нужна глобальная проп-фирма',
      'Нужно проверить страну и KYC',
      'Нужны российские фьючерсы',
  ...
  ['/ru/fundednext-vs-fundingpips', {
    ...
    markers: [
      ...
      'data-russian-comparison-source-links="9"',
      'data-russian-comparison-scenarios="three-like-for-like-pairs"',
      'data-russian-comparison-pair="instant"',
      'data-russian-comparison-pair="one-step"',
      'data-russian-comparison-pair="two-step"',
      ...
      '/go/fundednext?from=ru-comparison-fit-fundednext',
      '/go/fundingpips?from=ru-comparison-fit-fundingpips',
  ...
  ['/ru/prop-firmy-bez-chelendzha', {
    title: 'Проп-фирмы без челленджа 2026: FundedNext Instant',
    ...
    markers: [
      ...
      'data-russian-instant-evidence="fundednext"',
  ...
  ['/ru/vyplaty-prop-firm', {
    ...
    markers: [
      ...
      'data-russian-payout-matrix="3"',
      'data-russian-payout-evidence="fundednext"',
      'data-russian-payout-evidence="bright-funded"',
      'data-russian-payout-evidence="fundingpips"',
      'data-russian-payout-featured-partner="fundednext"',
      'data-russian-payout-featured-partner="bright-funded"',
      'data-russian-payout-gates="eligibility-request-processing-receipt"',
      'data-russian-payout-product-table="12"',
  ...
  ['/ru/obzor-fundingpips', {
    ...
    markers: [
      ...
      'data-russian-partner-editorial-shell="fundingpips"',
      ...
      '/go/fundingpips?from=ru-fundingpips-review-summary',
    ],
  }],
  ['/ru/obzor-bright-funded', {
  ...
  ['/ru/chto-takoe-prop-firma', {
    title: 'Что такое проп-фирма: как это работает в 2026 году',
    h1: 'Что такое проп-фирма и как она работает',
    markers: [
      ...
      'data-russian-prop-definition-products="7"',
      'data-russian-product-example="fundednext:stellar-2-step"',
      'data-russian-product-example="bright-funded:bright-funded-2-step-bright"',
  ...
  ['/ru/forex-prop-firmy', {
    ...
    markers: [
      ...
      'data-russian-affiliate-disclosure="forex-verdict"',
      '/go/fundednext?from=ru-forex-shortlist-fundednext',
  ...
  ['/ru/prop-firmy-s-ctrader', {
    ...
    markers: [
      ...
      'data-russian-ctrader-checkout-product="fundednext:stellar-2-step"',
      'data-russian-ctrader-checkout-product="fundednext:stellar-1-step"',
      'data-russian-ctrader-checkout-product="fundednext:stellar-lite"',
      'data-russian-ctrader-reference-product="bright-funded:bright-funded-1-step"',
      ...
      'https://help.brightfunded.com/en/articles/9241699-can-i-use-ea',
    ],
  }],
  ['/ru/fundednext-mt5', {
    ...
    markers: [
      ...
      'data-russian-fundednext-mt5-products="4"',
      'data-russian-fundednext-mt5-product-matrix="four-models"',
      'data-russian-fundednext-mt5-product="stellar-2-step"',
      'data-russian-fundednext-mt5-product="stellar-1-step"',
      'data-russian-fundednext-mt5-product="stellar-lite"',
      'data-russian-fundednext-mt5-product="stellar-instant"',
  ...
  ['/ru/fundednext-stellar-instant', {
    ...
    markers: [
      ...
      'data-russian-fundednext-instant-pricing="4"',
      'data-russian-fundednext-instant-price-table="source-gated"',
      'data-russian-fundednext-instant-tier="2000"',
      'data-russian-fundednext-instant-tier="5000"',
      'data-russian-fundednext-instant-tier="10000"',
      'data-russian-fundednext-instant-tier="20000"',
  ...
  ['/ru/obzor-teamtraders', {
    title: 'TeamTraders: отзывы и обзор условий 2026',
    h1: 'TeamTraders: отзывы и обзор условий 2026 года',
    markers: [
      ...
      'data-russian-teamtraders-global-partner="bright-funded"',
  ...
  ['/ru/otzyvy-prop-firm', {
    title: 'Отзывы о проп-фирмах 2026: как проверить выплаты',
    h1: 'Отзывы о проп-фирмах: проверка выплат, правил и KYC',
    markers: [
      ...
      'data-russian-reviews-featured-partner="fundednext"',
      'data-russian-reviews-featured-partner="bright-funded"',
...
for (const [path, href] of [
  ...
  ['/ru/dlya-russkoyazychnykh-treyderov', '/go/fundednext?from=ru-diaspora-hero-fundednext'],
  ['/ru/dlya-russkoyazychnykh-treyderov', '/go/bright-funded?from=ru-diaspora-hero-bright-funded'],
  ...
  ['/ru/dlya-russkoyazychnykh-treyderov', '/go/fundednext?from=ru-diaspora-regions-fundednext'],
  ['/ru/dlya-russkoyazychnykh-treyderov', '/go/bright-funded?from=ru-diaspora-regions-bright-funded'],
  ['/ru/fundednext-vs-bright-funded', '/go/fundednext?from=ru-fn-vs-bright-fundednext'],
  ['/ru/fundednext-vs-bright-funded', '/go/bright-funded?from=ru-fn-vs-bright-bright-funded'],
  ['/ru/fundednext-vs-bright-funded', '/go/fundednext?from=ru-fn-vs-bright-instant'],
  ['/ru/fundednext-vs-bright-funded', '/go/fundednext?from=ru-fn-vs-bright-verdict-fundednext'],
  ['/ru/fundednext-vs-bright-funded', '/go/bright-funded?from=ru-fn-vs-bright-verdict-bright-funded'],
  ...
  ['/ru/prop-firmy-bez-chelendzha', '/go/fundednext?from=ru-instant-fundednext'],
  ...
  ['/ru/chto-takoe-prop-firma', '/go/fundednext?from=ru-prop-definition-fundednext'],
  ['/ru/chto-takoe-prop-firma', '/go/bright-funded?from=ru-prop-definition-bright-funded'],
  ['/ru/forex-prop-firmy', '/go/fundednext?from=ru-forex-shortlist-fundednext'],
  ...
  ['/ru/prop-firmy-s-ctrader', '/go/fundednext?from=ru-ctrader-hero-fundednext'],
  ['/ru/prop-firmy-s-ctrader', '/go/bright-funded?from=ru-ctrader-hero-bright-funded'],
  ['/ru/prop-firmy-s-ctrader', '/go/fundednext?from=ru-ctrader-shortlist-fundednext'],
  ['/ru/prop-firmy-s-ctrader', '/go/bright-funded?from=ru-ctrader-shortlist-bright-funded'],
  ['/ru/prop-firmy-s-ctrader', '/go/fundednext?from=ru-ctrader-verdict-fundednext'],
